...
import { Button, Col, Form, FormGroup, Input, Modal, ModalBody, ModalFooter, ModalHeader, Row, Table } from 'reactstrap';
...
class RawData extends Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Button color="dark" onClick={this.toggleMeq} className="w-100 mb-2" >Input Data Hasil Uji</Button>
...
RawData.propTypes = propTypes;
RawData.defaultProps = defaultProps;

  ...
  render() {
    ...
    return (
      <div className="animated fadeIn bg-white" style={margin}>
        ...
        {/* Header Section */}
        <Row className="border mb-2 page-header" style={{ padding: "0 15px", margin: "0 -15px" }}>
          <Col xs="3 my-auto">
        ...
        <table>
          ...
          <tbody>
            <tr>
              <td>
                {/* Body Section */}
                <div className="border content-block" style={{ padding: "0 15px", margin: "0 -15px", height: "1200px" }}>
                  ...
                  <div className="position-absolute border" style={{ right: "75px", height: "240px", width: "360px", top: "480px" }}>
                    <div className="h-100">
                      <img className="w-100 h-100 p-2" src="http://localhost:8900/api/uploads/devices/test.jpg" alt="Calibration" />
                    </div>
                  </div>
        ...
        {/* Footer Section */}
        <div className="border page-footer" style={{ padding: "0 15px", margin: "0 -15px" }}>
          {/* Page Number */}
          <Row>
            <Col xs="6" className="text-left">
              FILE: 067-kal-19
                    </Col>
            <Col sx="6" className="text-right" id="pageFooter"></Col>
          </Row>

...
class Total extends Component {
  ...
  getData = () => {
    axios.get(localStorage.getItem('serverAPI') + '/devices')
      .then(res => {
      ...
      <div className="animated fadeIn">
        <Row>
          <Col xs="12" xl="12">
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify"></i><strong>Perangkat Lab Total</strong>
                  ...
                  <ModalBody className="modal-body-display">
                    <Col xs="12" className="m-auto">
                      <Row>
                        ...
                        <div className="w-100 py-2"></div>
                        <Col xs="12" className="m-auto">
                          <img className="d-block w-100" src={process.env.REACT_APP_API_PATH + '/uploads/devices/' + this.state.focus.documentation} alt='Total' />
                        </Col>
                        <div className="w-100 py-2"></div>
                        <Col xs="12">

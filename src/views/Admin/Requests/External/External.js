...
class External extends Component {
  ...
  getData = () => {
    axios.get(localStorage.getItem('serverAPI') + '/devices/owner/EXT')
      .then(res => {
      ...
      <div className="animated fadeIn">
        <Row>
          <Col xs="12" xl="12">
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify"></i><strong>Perangkat External</strong>
                ...
                <Modal isOpen={this.state.view} toggle={() => this.toggleView(this.state.id)} className={'modal-primary modal-lg ' + this.props.className}>
                  ...
                  <ModalBody className="modal-body-display">
                    ...
                    <Col sm="12" lg="7" className="m-auto">
                      <img className="d-block w-100" src={process.env.REACT_APP_API_PATH + '/uploads/devices/' + this.state.focus.documentation} alt='External' />
                    </Col>
                  </ModalBody>
                  <ModalFooter>

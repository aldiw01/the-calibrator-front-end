...
class Transmission extends Component {
  ...
  getData = () => {
    axios.get(process.env.REACT_APP_API_PATH + '/devices/owner/TRA')
      .then(res => {
      ...
      <div className="animated fadeIn">
        <Row>
          <Col xs="12" xl="12">
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify"></i><strong>Perangkat Transmisi</strong>
                  ...
                  <ModalBody className="modal-body-display">
                    <Col sm="12" lg="5" className="m-auto">
                      <Row>
                        ...
                        <Col xs="7" className="border-bottom mt-auto" style={viewStyle}>{this.state.focus.issue_date}</Col>
                        <div className="w-100 py-2"></div>
                    ...
                    <Col sm="12" lg="7" className="m-auto">
                      <img className="d-block w-100" src={process.env.REACT_APP_API_PATH + '/uploads/devices/' + this.state.focus.documentation} alt='Transmission' />
                    </Col>
                  </ModalBody>
                  <ModalFooter>
